	...
	public static void main(String[] args) {
		...
		if(A.equals("yes")) {
			...
			if(B.equals("through")) {
				...
				if(C.equals("3")) {
					JOptionPane.showMessageDialog(null, "It was empty and the door closed you rot in there.");	
					System.exit(0);
				...
				if(C.equals("4")) {
					JOptionPane.showMessageDialog(null, "You found the treasure you win!!!But how do we get out?");	
					System.exit(0);
